...
public partial class AboutPage : PanelContainer, IPage
{
    ...
    public override void _Ready()
    {
        ...
        GetNode<Label>("MarginContainer/VBoxContainer/AppVersion").Text = $"Version {appVersion}";
        ...
        GetNode<Label>("MarginContainer/VBoxContainer/DataVersion").Text = $"Game data as of {dataVersion}";
    }
}
